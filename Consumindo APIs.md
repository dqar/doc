...
- **700700 - API blocked**
  * Esta API foi bloqueada temporariamente. Tente novamente mais tarde ou entre em contato com os administradores do sistema. Invocar uma API que está no e# Consumindo APIs disponibilizadas pelo SERPRO
...
## Aplicabilidades
stado de ciclo de vida BLOCKED
